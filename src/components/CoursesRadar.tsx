  ...
  return (
    <div className="bg-white rounded-xl p-4 w-full h-full">
      ...
      <ResponsiveContainer width="100%" height="100%">
        <RadarChart cx="50%" cy="50%" outerRadius="82%" data={coursesRadarData}>
          <PolarGrid />
          <PolarAngleAxis dataKey="subject" />
          <PolarRadiusAxis angle={30} domain={[0, 150]} />
          <Radar name="2024" dataKey="A" stroke="#8884d8" fill="#8884d8" fillOpacity={0.4} />
          <Radar name="2025" dataKey="B" stroke="#82ca9d" fill="#82ca9d" fillOpacity={0.4} />
          <Legend align="center"
            verticalAlign="top"
