...
import { role, eventColHeaders, eventsData } from '@/lib/data'
...
const ResultListPage = () => {
  const renderRow = (item: Event) => (
    ...
    >
      ...
      <td className="text-xs md:text-sm">{item.startTime}</td>
      <td className="text-xs md:text-sm">{item.endTime}</td>
      <td>
